...
/// Used by upstream to control the submission rate by adjusting the difficulty target on a
/// specified channel.
///
/// All submits leading to hashes higher than the specified target will be rejected by the
/// upstream.
///
