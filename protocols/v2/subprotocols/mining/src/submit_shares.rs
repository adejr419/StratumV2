...
/// Used by upstream as a response to [`SubmitSharesStandard`] or [`SubmitSharesExtended`], indicating
/// valid submission of shares.
///
...
pub struct SubmitSharesError<'decoder> {
    ...
    /// Unique sequential identifier of the submit within the channel.
    pub sequence_number: u32,
    /// Reason for rejecting the share(s) submission.
    ///
