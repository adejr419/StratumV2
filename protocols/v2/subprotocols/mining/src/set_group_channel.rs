...
/// Used by upstream to associates a set of standard channels with a group channel.
///
...
///
/// This message can be sent only to connections that don’t have `REQUIRES_STANDARD_JOBS` flag in
/// [`SetupConnection`].
///
/// [`NewExtendedMiningJob`]: crate::NewExtendedMiningJob
/// [`NewMiningJob`]: crate::NewMiningJob
/// [`SetupConnection`]: crate::SetupConnection
