...
/// Message used by a downstream to request data about all transactions in a block.
///
...
/// Message used by an upstream to respond with an error to a [`RequestTransactionData`] message.
#[derive(Serialize, Deserialize, Debug, Clone, PartialEq, Eq)]
