...
/// transactions for inclusion in a block(to avoid an invalid, oversized block).  Thus, this message
/// indicates that additional space in the block/coinbase transaction must be reserved for, assuming
/// they will use the entirety of this space.
///
